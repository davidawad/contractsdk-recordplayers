...
import net.corda.samples.contractsdk.contracts.TemplateContract;
import net.corda.samples.contractsdk.states.TemplateState;
...
public class IssueRecordPlayerFlow extends FlowLogic<SignedTransaction> {
    ...
    //public constructor
    public IssueRecordPlayerFlow(Party sendTo){
